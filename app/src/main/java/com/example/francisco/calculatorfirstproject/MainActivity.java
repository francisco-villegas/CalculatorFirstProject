package com.example.francisco.calculatorfirstproject;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBracketEnd = (Button) findViewById(R.id.btnBracketEnd);
        btnBracketStart = (Button) findViewById(R.id.btnBracketStart);
